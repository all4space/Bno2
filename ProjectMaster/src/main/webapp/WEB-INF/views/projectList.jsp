                  ...
                  <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <c:forEach items = "${projectList}" var = "vo" varStatus="status">
                     <tr>
                        ...
                        <c:choose>
                        <c:when test = "${users.authority eq 'cto' || users.authority eq 'CTO'}">
                        <td class="center">
                        ...
                        <c:when test = "${users.authority ne 'cto' || users.authority ne 'CTO'}">
                           <c:choose>
                           <c:when test = "${member[status.index].projectAuthority eq 'Manager' || member[status.index].projectAuthority eq 'manager'}">
                           <td class="center">
                              <a class="btn btn-info" href="/planbe/project/projectUpdateForm?projectNo=${vo.projectNo}">
                                 <i class="halflings-icon white edit"></i>  
                              </a>
...
<%--                            <c:when test = "${member[status.index].projectAuthority eq 'Member' ||member[status.index].projectAuthority eq 'member' }">
                           <td>ㅇㅇㅇㅇ</td>
                           </c:when> --%>
                           </c:choose>
                           <td></td>
