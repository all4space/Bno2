			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Project Update</h2>
						<div class="box-icon">
						...
						<form action = "/planbe/project/projectUpdate" method = "post" class="form-horizontal">
						  <fieldset>
							...
							<input type = "hidden" value = "${projectList.projectNo}" name = "projectNo">
							  ...
							  <a href = "/planbe/project/projectList"><button class="btn">Cancel</button></a>
							</div>
